...
def simplex_aux(progL, file_f, extra_col, aux_base):
    ...
    progL_aux = pl.PL(progL.A, progL.c, progL.FPI_b, progL.n, progL.m, progL.FPI_op_matrix, base)
    progL_aux.make_FPI()
...
#Conclusion printing
def print_conc(s, vo, y, case, file_g):
    if(case == 1):
        #Optimal
        file_g.write("2\n") 
        file_g.write(s)
